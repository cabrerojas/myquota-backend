...
| Adding a new entity | `myquota-module` |
| Adding business logic | `myquota-service` |
| Adding custom repository methods | `myquota-repository` |
...
| Generating module boilerplate | `myquota-module` |
...
| Injecting dependencies | `myquota-service` |
...
| Working with Firestore paths | `myquota-repository` |
